...
namespace shilka2
{
    class Constants
    {
        ...
        // training
        public const string SUSPENDED_TARGET_INFORMATION = "ТРЕНИРОВКА\n\nВ начале подготовки зенитчиков используют подвесные мишени, " +
            "которые необходимо расстрелять из зенитных пушек. Это самый простой вид тренировки из всех существующих.\n\n[ OK ]";
