...
namespace shilka2
{
    class Constants
    {
        ...
        //school
        public const string ENEMY_INFORMATION = "ПЕРВЫЙ ВРАЖЕСКИЙ САМОЛЁТ\n\nСейчас появится первый вражеский самолёт " +
            "- все он и выделены красным цветом. Вы должны сбить его или хотя бы повредить. Шкала подскажет вам насколько " +
            "он повреждён.";
        public const string FRIEND_INFORMATION = "ПЕРВЫЙ ДРУЖЕСТВЕННЫЙ САМОЛЁТ\n\nСейчас появится первый дружественный самолёт " +
            "- все он и выделены зелёным цветом. Нужно избегать повреждать свои самолёты. Если вы собьёте его, то игра будет " +
            " провалена. Шкала подскажет вам насколько он повреждён.";
        public const string AIRLINER_INFORMATION = "ПЕРВЫЙ ПАССАЖИРСКИЙ САМОЛЁТ\n\nСейчас появится первый пассажирский самолёт " +
            "- все он и выделены зелёным цветом. Нужно избегать повреждать пассажирские самолёты. Если вы собьёте его, то " +
            "игра будет провалена. Шкала подскажет вам насколько он повреждён.";
    }
}
