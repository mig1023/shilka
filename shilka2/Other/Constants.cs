...
namespace shilka2
{
    class Constants
    {
        ...
        {
            [Scripts.ScriptsNames.Vietnam] = "ВОЙНА ВО ВЬЕТНАМЕ\n\nОдин из крупнейших военных конфликтов второй половины XX века, оставивший заметный след в культуре и занимающий существенное место в новейшей истории Вьетнама, а также США и СССР, сыгравших в нём немаловажную роль. Развивалась с 1955 года до падения Сайгона в 1975 году.\nОсобенность: вражеских самолётов и вертолётов очень много.\n\n[ OK ]",
            [Scripts.ScriptsNames.DesertStorm] = "БУРЯ В ПУСТЫНЕ\n\nЧасть войны в Персидском заливе 1990-1991 годов, операция многонациональных сил против вооружённых сил Ирака, после вторжения последних в Кувейт.\nОсобенность: зенитная работа в условиях постоянных песчанных бурь.\n\n[ OK ]",
            [Scripts.ScriptsNames.Yugoslavia] = "БОМБАРДИРОВКИ ЮГОСЛАВИИ\n\nВоенная агрессия НАТО против Югославии, совершённая в 1999 году под предлогом этнических чисток.\nОсобенность: зенитная работа в ночное время.\n\n[ OK ]",
            [Scripts.ScriptsNames.IranIraq] = "ИРАНО-ИРАКСКАЯ ВОЙНА\n\nКровопролитная война, длившаяся с 1980 по 1988 годы. Причиной войны стало желание Ирака отобрать богатые нефтью районы у Ирана, оказавшегося в тот период в сравнительной междунарожной изоляции после исламской революции.\nОсобенность: повреждённый радар, проблемы с наведением пушек.\n\n[ OK ]",
            [Scripts.ScriptsNames.Syria] = "ГРАЖДАНСКАЯ ВОЙНА В СИРИИ\n\nМногосторонний, многоуровневый вооружённый конфликт на территории Сирии, начавшийся весной 2011 года как гражданское война, постепенно переросший в арену противостояния множества не только основных государства региона, но и международных организаций, религиозных и военно-политических группировок, а также мировых держав.\nОсобенность: враги применяют только дроны, беспилотники и крылатые ракеты.\n\n[ OK ]",
            [Scripts.ScriptsNames.Libya] = "ИНТЕРВЕНЦИЯ В ЛИВИИ\n\nВоенная агрессия НАТО против Ливии, охваченной в тот момент гражданской войной.\nОсобенность: повреждённые системы и непредсказуемая работа пушек.\n\n[ OK ]",
            [Scripts.ScriptsNames.Yemen] = "ВОЙНА В ЙЕМЕНЕ\n\nВторжение ряда арабских стран, в первую очередь Саудовской Аравии, в внутренний йеменский конфликт. Характерной особенностью войны было большое количество воздушных ударов по гражданским объектам, приведшим к значительному количеству погибших мирных жителей.\nОсобенность: здесь нет никаких союзников, только враги.\n\n[ OK ]",
            [Scripts.ScriptsNames.Rust] = "ПОЛЁТ МАТИАСА РУСТА\n\nВ мае 1987 немецкий пилот Матиас Руст, вылетев из Хельсинки на лёгком одномоторном самолёте Cessna, нарушил границу СССР и приземлился на Красной площади. Случившийся инцидент имел большой резонанс и широко использовался в политических целях.\nОсобенность: гражданский самолёт в качестве цели.\n\n[ OK ]",
            [Scripts.ScriptsNames.F117Hunt] = "ОХОТА НА НЕВИДИМКУ\n\nВ марте 1999 недалеко от Белграда был сбит F-117 из состава американских ВВС.\nОсобенность: необходимо выследить одну конкретную цель и уничтожить её.\n\n[ OK ]",
            [Scripts.ScriptsNames.Khmeimim] = "ОБОРОНА ХМЕЙМИМА\n\nВоенная база России на территории Сирии - Хмеймим - подвергалась постоянным ударам стай беспилотников, которые использовали боевики.\nОсобенность: борьба с роем беспилотников.\n\n[ OK ]",
            [Scripts.ScriptsNames.Belgrad] = "НАЛЁТ НА БЕЛГРАД\n\nБомбардировки Югославии в 1999 году характеризовались массовыми ударами по гражданским и инфраструктурным объектам. Большому количеству ударов подвергся и Белград, где был уничтожен телецентр, мосты и другие гражданские объекты.\nОсобенность: одно направление нападения.\n\n[ OK ]",
            [Scripts.ScriptsNames.Turkey] = "ТУРЕЦКОЕ ВТОРЖЕНИЕ\n\nВ феврале-марте 2020 года произошло крупное столкновение сирийских правительственных силы с турецкими войсками, находившимися на территории Сирии. Боестолкновения характеризовались масштабным применением Турцией своих БПЛА Bayraktar и ANKA.\nОсобенность: только ударные беспилотники.\n\n[ OK ]",
        };
    }
}
